...
//	private int ord_code;			
	...
	private double och_mon_sum;
	private double och_su_sum;
	private double och_mon_tax; //부가세
	private double och_mon_total; //합계금액
	
	//거래명세서용
	private int och_su_report;
	private double och_dang_report;
	private double och_mon_report;
	private double och_amnt_report;
	...
	private List<Integer> och_code_list;
	private List<Integer> och_no_list;
	
	private String ingam_img;	
	...
	public List<Integer> getOch_code_list() {
		return och_code_list;
	}
	public void setOch_code_list(List<Integer> och_code_list) {
		this.och_code_list = och_code_list;
	}
	public List<Integer> getOch_no_list() {
		return och_no_list;
	}
	public void setOch_no_list(List<Integer> och_no_list) {
		this.och_no_list = och_no_list;
	}
	public double getOch_mon_sum() {
		return och_mon_sum;
	}
	public void setOch_mon_sum(double och_mon_sum) {
		this.och_mon_sum = och_mon_sum;
	}
	public double getOch_su_sum() {
		return och_su_sum;
	}
	public void setOch_su_sum(double och_su_sum) {
		this.och_su_sum = och_su_sum;
	}
	public double getOch_mon_tax() {
		return och_mon_tax;
	}
	public void setOch_mon_tax(double och_mon_tax) {
		this.och_mon_tax = och_mon_tax;
	}
	public double getOch_mon_total() {
		return och_mon_total;
	}
	public void setOch_mon_total(double och_mon_total) {
		this.och_mon_total = och_mon_total;
	}
	public int getOch_su_report() {
		return och_su_report;
	}
	public void setOch_su_report(int och_su_report) {
		this.och_su_report = och_su_report;
	}
	public double getOch_dang_report() {
		return och_dang_report;
	}
	public void setOch_dang_report(double och_dang_report) {
		this.och_dang_report = och_dang_report;
	}
	public double getOch_mon_report() {
		return och_mon_report;
	}
	public void setOch_mon_report(double och_mon_report) {
		this.och_mon_report = och_mon_report;
	}
	...
	public String getIngam_img() {
		return ingam_img;
	}
	public void setIngam_img(String ingam_img) {
		this.ingam_img = ingam_img;
	}
	public double getOch_amnt_report() {
		return och_amnt_report;
	}
	public void setOch_amnt_report(double och_amnt_report) {
		this.och_amnt_report = och_amnt_report;
	}
}
