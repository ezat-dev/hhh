                    ...
                    <div class="field-section">
                        ...
                        <div class="process-check-grid">
                            <div class="process-item">
                                <input type="checkbox" id="prod_fac1">
                                <label for="prod_fac1">전세정</label>
                            </div>
                            <div class="process-item">
                                <input type="checkbox" id="prod_fac2">
                                <label for="prod_fac2">방탄</label>
                            </div>
                            <div class="process-item">
                                <input type="checkbox" id="prod_fac3">
                                <label for="prod_fac3">침탄</label>
                            </div>
                            <div class="process-item">
                                <input type="checkbox" id="prod_fac4">
                                <label for="prod_fac4">고주파</label>
                            </div>
                            <div class="process-item">
                                <input type="checkbox" id="prod_fac5">
                                <label for="prod_fac5">후세정</label>
                            </div>
                            <div class="process-item">
                                <input type="checkbox" id="prod_fac6">
                                <label for="prod_fac6">템퍼링</label>
                            </div>
                            <div class="process-item">
                                <input type="checkbox" id="prod_fac7">
                                <label for="prod_fac7">쇼트</label>
                            </div>
                            <div class="process-item">
                                <input type="checkbox" id="prod_fac8">
