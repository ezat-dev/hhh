...
.jg-modal-body::-webkit-scrollbar { width: 5px; }
.jg-modal-body::-webkit-scrollbar-track { background: #e0e0e0; }
.jg-modal-body::-webkit-scrollbar-thumb { background: #999; border-radius: 4px; }
...
.jg-section:last-child { margin-bottom: 0; }
.jg-section-title {
...
.jg-col { display: flex; flex-direction: column; gap: 2px; }
.jg-col-full { grid-column: 1/-1; display: flex; flex-direction: column; gap: 2px; }
.jg-col label, .jg-col-full label {
...
.jg-col select,
.jg-col-full input[type="text"] {
    width: 100%; height: 26px;     /* ★ 고정 높이 */
}
.jg-col input:focus, .jg-col select:focus,
.jg-col-full input:focus {
    outline: none; border-color: #4dabf7;
    box-shadow: 0 0 0 2px rgba(77,171,247,0.1);
}
.jg-col input[readonly], .jg-col input[disabled],
...
.file-name-display {
    ...
    color: #6c757d; font-style: italic; font-size: 10px;
}
...
.drawing-modal-title { font-weight: bold; font-size: 16px; color: #2c3e50; }
.drawing-modal-body {
    flex: 1; overflow: auto;
    display: flex; align-items: center; justify-content: center;
}
.drawing-modal-body img { max-width: 100%; max-height: 100%; object-fit: contain; }

/* ========== 반응형 ========== */
@media (max-width: 700px) {
    .jg-insert-box { width: 95vw; }
    .jg-row { grid-template-columns: 1fr; }
}
    </style>
...
<form autocomplete="off" method="post" id="jeomgeomInsertForm" name="jeomgeomInsertForm" enctype="multipart/form-data">
