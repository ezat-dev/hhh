...
<div class="tab">
    <div class="button-container" style="margin-left:20px;">
        <button class="select-button" type="button" onclick="selectHogiBtn(0);" id="selectHogi0">
            전체호기
        </button>
        <button class="select-button" type="button" onclick="selectHogiBtn(1);" id="selectHogi1">
            침탄로 1호기
        </button>
        <button class="select-button" type="button" onclick="selectHogiBtn(2);" id="selectHogi2">
            침탄로 2호기
        </button>
        <button class="select-button" type="button" onclick="selectHogiBtn(3);" id="selectHogi3">
            침탄로 3호기
        </button>
        <button class="select-button" type="button" onclick="selectHogiBtn(4);" id="selectHogi4">
            침탄로 4호기
        </button>
        <button class="select-button" type="button" onclick="selectHogiBtn(18);" id="selectHogi18">
            침탄로 5호기
        </button>
	</div>
</div>
		...
		<div class="j_container">				
			<div class="j_row1">
				...
				<div class="j_div">
					...
					<button class="iRowBtn margin_left" type="button" onclick="sdateTimeSetBtn('bcfStart');"
				...
				<div class="j_div">
					...
					<button class="iRowBtn margin_left" type="button" onclick="sdateTimeSetBtn('bcfEnd');"
					style="display:inline-block;">종료</button>						
				</div>
				
				<div class="j_div">
					<label for="" class="margin_left iRowLabel">총 수량</label>
					<input type="text" name="bcf_total_cnt" class="margin_left iRowInput" value="0" disabled="disabled"/>				
				</div>
				
				<div class="j_div">
					<label for="" class="margin_left iRowLabel">총 중량</label>
					<input type="text" name="bcf_total_weight" class="margin_left iRowInput" value="0" disabled="disabled"/>				
				</div>
			</div>
		</div>		
		<hr />		
		...
		<div class="bcfInfo1">
			...
			<div class="j_container">
				<div class="j_row1">
					...
					<div class="j_div">
						<input type="text" name="prod_si1" class="iRowInput2 margin_left" style="width:50px !important;" readonly="readonly"/>				
					</div>
					<div class="j_div">
						<input type="text" name="prod_si1_msg" class="iRowInput2 margin_left" style="width:140px !important;" readonly="readonly"/>				
					</div>
					<div class="j_div">
						<input type="text" name="prod_si2" class="iRowInput2 margin_left" style="width:50px !important;" readonly="readonly"/>				
					</div>
					<div class="j_div">
						<input type="text" name="prod_si2_msg" class="iRowInput2 margin_left" style="width:140px !important;" readonly="readonly"/>				
					</div>
				</div>
			</div>
			...
			<div class="j_container">
				<div class="j_row1">
					<div class="j_div">
						<label class="iRowLabel2" style="width:180px !important;">바스켓(파손,변형없을것)</label>						
					...
					<div class="j_div">
						<label class="iRowLabel2" style="width:180px !important;">체인(변형,파손)</label>
					</div>
					<div class="j_div">
			...
			<div class="j_container">
				<div class="j_row1">
					<div class="j_div">
						<label class="iRowLabel2" style="width:180px !important;">부품혼입</label>						
					...
					<div class="j_div">
						<label class="iRowLabel2" style="width:180px !important;">L/S(변형,파손)</label>
					</div>
					<div class="j_div">
					...
					<div class="j_div">
						<label class="iRowLabel2" style="width:180px !important;">레일(변형,파손)</label>
					</div>
					<div class="j_div">
		...
		<div class="j_container">
			<form id="workBcfDanchForm" name="workBcfDanchForm" autocomplete="off" style="width:100%;">
				<div class="j_row1">
					...
					<input type="text" id="bcf_danch_sdate" class="iRowInput_180 datetimepicker_date" 
					style="width:100px;">
					~
					<input type="text" id="bcf_danch_edate" class="iRowInput_180 datetimepicker_date" 
					style="width:100px;">				
...
//		getWorkDataList();
		...
		workDataTable = new Tabulator("#workTabu", {
		    ...
		    columns:[	 		    	
		        ...
		        {title:"수주NO", field:"ord_code", sorter:"string", width:80,
			        hozAlign:"center"},	        
		        {title:"적재코드", field:"danch_barcode", sorter:"string", width:80,
		        	hozAlign:"center"},
		        {title:"생산LOT", field:"ilbo_lot", sorter:"string", width:100,
		        	hozAlign:"center"},
		        ...
		        {title:"거래처", field:"corp_name", sorter:"string", width:120,
			        hozAlign:"center"},	
		        {title:"품명", field:"prod_name", sorter:"string", width:180,
			        hozAlign:"center"},	
	...
	function getWorkBcfData(){
		...
		workBcfDataTable = new Tabulator("#workBcfTabu", {
		    ...
		    headerSort:false,
		    ajaxResponse:function(url, params, response){
				$("#workBcfTabu .tabulator-col.tabulator-sortable").css("height","30px");
		        return response; //return the response data to tabulator
		    },
		    columns:[	    	
			...
			rowClick:function(e, row){
				...
				$("#workBcfTabu .tabulator-tableHolder > .tabulator-table > .tabulator-row").each(function(index, item){
						
					if($(this).hasClass("row_select")){							
						$(this).removeClass('row_select');
						row.getElement().className += " row_select";
					}else{
						$("#workBcfTabu div.row_select").removeClass("row_select");
						row.getElement().className += " row_select";	
					}
				});
			}
	...
	function getWorkBcfDanchData(){
		...
		workBcfDanchDataTable = new Tabulator("#workBcfDanchTabu", {
		    ...
		    headerSort:false,
		    ajaxResponse:function(url, params, response){
				$("#workBcfDanchTabu .tabulator-col.tabulator-sortable").css("height","55px");
		        return response; //return the response data to tabulator
		    },
		    columns:[		    	
			...
			rowClick:function(e, row){
				...
				$("#workBcfDanchTabu .tabulator-tableHolder > .tabulator-table > .tabulator-row").each(function(index, item){
						
					if($(this).hasClass("row_select")){							
						$(this).removeClass('row_select');
						row.getElement().className += " row_select";
					}else{
						$("#workBcfDanchTabu div.row_select").removeClass("row_select");
						row.getElement().className += " row_select";	
					}
				});
			},
...
//테스트
//				workDanDataTable.addData(workBcfDanchSelectData);
