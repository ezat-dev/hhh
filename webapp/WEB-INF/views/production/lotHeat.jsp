...
#tab2 .tabulator-header,
#tab3 .tabulator-header,
#tab5 .tabulator-header,
#tab6 .tabulator-header {
...
#tab2 .tabulator-col.tabulator-sortable:hover,
#tab3 .tabulator-col.tabulator-sortable:hover,
#tab5 .tabulator-col.tabulator-sortable:hover,
#tab6 .tabulator-col.tabulator-sortable:hover {
    background: rgba(255,255,255,.08);
}
#tab1 .tabulator-col-title,
#tab2 .tabulator-col-title,
#tab3 .tabulator-col-title,
#tab5 .tabulator-col-title,
#tab6 .tabulator-col-title {
    color: #ffffff;
    font-weight: 700;
}
#tab1 .tabulator-col .tabulator-header-filter input,
#tab2 .tabulator-col .tabulator-header-filter input,
#tab3 .tabulator-col .tabulator-header-filter input,
#tab5 .tabulator-col .tabulator-header-filter input,
#tab6 .tabulator-col .tabulator-header-filter input {
    border: none;
    border-radius: 5px;
    padding: 4px 6px;
    font-size: 11px;
...
#tab2 .tabulator-col .tabulator-header-filter input:focus,
#tab3 .tabulator-col .tabulator-header-filter input:focus,
#tab5 .tabulator-col .tabulator-header-filter input:focus,
#tab6 .tabulator-col .tabulator-header-filter input:focus {
    outline: none;
    background: #ffffff;
...
#tab2 .tabulator-row.tabulator-row-even,
#tab3 .tabulator-row.tabulator-row-even,
#tab5 .tabulator-row.tabulator-row-even,
#tab6 .tabulator-row.tabulator-row-even {
    background-color: #F7FAFC;
}
#tab1 .tabulator-row:hover,
#tab2 .tabulator-row:hover,
#tab3 .tabulator-row:hover,
#tab5 .tabulator-row:hover,
#tab6 .tabulator-row:hover {
    background-color: #EBF8FF !important;
    box-shadow: inset 0 0 0 1px #3182CE;
}
#tab1 .tabulator-row.row_select,
#tab2 .tabulator-row.row_select,
#tab3 .tabulator-row.row_select,
#tab5 .tabulator-row.row_select,
#tab6 .tabulator-row.row_select {
...
#tab2 .tabulator-footer,
#tab3 .tabulator-footer,
#tab5 .tabulator-footer,
#tab6 .tabulator-footer {
    background: #F7FAFC;
    border-top: 1px solid #E2E8F0;
    padding: 8px 12px;
}
#tab1 .tabulator-footer .tabulator-calcs-holder,
#tab2 .tabulator-footer .tabulator-calcs-holder,
#tab3 .tabulator-footer .tabulator-calcs-holder,
#tab5 .tabulator-footer .tabulator-calcs-holder,
#tab6 .tabulator-footer .tabulator-calcs-holder {
...
#tab2 .tabulator-page.active,
#tab3 .tabulator-page.active,
#tab5 .tabulator-page.active,
#tab6 .tabulator-page.active {
    background: #3182CE;
    border-color: #2B6CB0;
    color: #ffffff;
}
#tab1 .tabulator-page:not(:disabled):hover,
#tab2 .tabulator-page:not(:disabled):hover,
#tab3 .tabulator-page:not(:disabled):hover,
#tab5 .tabulator-page:not(:disabled):hover,
#tab6 .tabulator-page:not(:disabled):hover {
    background: #EBF8FF;
    border-color: #BEE3F8;
    color: #2B6CB0;
    cursor: pointer;
